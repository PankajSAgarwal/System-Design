...
_You should always clarify requirements at the beginning of the interview. Be sure to ask questions to find the exact scope of the system that the interviewer has in mind._
...
Assumptions : new url shortenings per month = 500 M
...
*New URLs shortenings per second: 500 million (30*24*3600) = ~200 URLs/sec*
